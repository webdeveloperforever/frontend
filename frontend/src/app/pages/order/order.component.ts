...
export class OrderComponent implements OnInit, OnDestroy {
  ...
  SortDirection = 'asc';
    ...
    exportAsXLSX():void{
        this.orderService.getAll().subscribe(response => this.orderInfo= response,error=>console.log(error));
        console.log(this.orderInfo);
        this.excelService.exportAsExcelFile(this.orderInfo,"SalesReport");
}
onSortDirection() {
