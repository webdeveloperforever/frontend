...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<ProductInfo> findProductWithSortAsc(String field) {
		// TODO Auto-generated method stub
		return  productInfoRepository.findAll(Sort.by(Sort.Direction.ASC,field));
	}

	@Override
	public List<ProductInfo> findProductWithSortDsc(String field) {
		// TODO Auto-generated method stub
		return  productInfoRepository.findAll(Sort.by(Sort.Direction.DESC,field));
	}
