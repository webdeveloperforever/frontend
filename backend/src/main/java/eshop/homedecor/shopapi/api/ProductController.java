...
import eshop.homedecor.shopapi.service.impl.ProductServiceImpl;
...
//        }
    ...
    @GetMapping("ascsort/{field}")
    public List<ProductInfo> findAllSortByAsc(@PathVariable String field) {
        List<ProductInfo> allinfo=productService.findProductWithSortAsc(field);
        return allinfo;
    }
    @GetMapping("dscsort/{field}")
    public List<ProductInfo> findAllSortByDsc(@PathVariable String field) {
        List<ProductInfo> allinfo=productService.findProductWithSortDsc(field);
        return allinfo;
    }
